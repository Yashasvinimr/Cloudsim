...
public class SJFSchedulingExample {
    ...
    public static void main(String[] args) {
        try {
            ...
            // Sort cloudlets by length (Shortest Job First - SJF)
            ...
            // Sort finished cloudlets by their finish time
            finishedCloudlets.sort(Comparator.comparingDouble(Cloudlet::getFinishTime));

            // Print results in order of finish time
            System.out.println("Cloudlet ID | Status | Start Time | Finish Time");
            for (Cloudlet cloudlet : finishedCloudlets) {
                System.out.printf("%-12d | %-6s | %-10.2f | %-11.2f\n", cloudlet.getCloudletId(),
                        cloudlet.getCloudletStatusString(), cloudlet.getExecStartTime(), cloudlet.getFinishTime());
            }
